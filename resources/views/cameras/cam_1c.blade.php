        ...
        <div style="position:relative; z-index:2; display:flex; justify-content:center; align-items:flex-end; height:100%; padding-bottom:16%;">
            ...
            @if($foxy_stage == 1)
                ...
                <div style="text-align:center;">
                    ...
                    ">
                        <div style="color:#7a4a3a; font-size:10px; padding-bottom:6px;">zzz...</div>
                    </div>
            ...
            @elseif($foxy_stage == 3)
                ...
                <div style="text-align:center; filter: drop-shadow(0 0 14px rgba(200,60,30,0.4));">
                    <div style="font-size:78px; line-height:1; transform: scaleX(-1);">🦊</div>
            ...
            @else
                ...
                <div style="text-align:center;">
                    <div style="
                        ...
                        border: 1px dashed #331a10;
                        border-radius: 6px 6px 0 0;
                    "></div>
                    <div style="color:#552222; font-size:11px; letter-spacing:2px; margin-top:6px;">⚠ БУХТА ПУСТА</div>
                </div>
            @endif
        </div>
    </div>
